...
def yolo(frame, size, score_threshold, nms_threshold):
    """YOLO 시작"""
    # YOLO 네트워크 불러오기
    net = cv2.dnn.readNet("./ch99/yolonew/yolov4-obj_final.weights",
                          "./ch99/yolonew/yolov4-obj.cfg")
...
# lgbm_t.pkl 파일 불러오기
with open('./ch99/yolonew/lgbm_t.pkl', 'rb') as f:
